...
import (
	...
	"github.com/operator-framework/operator-sdk-samples/couchdb-operator/pkg/apis"
	"github.com/operator-framework/operator-sdk-samples/couchdb-operator/pkg/controller"
